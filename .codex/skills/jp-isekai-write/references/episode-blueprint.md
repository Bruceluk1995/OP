...
Use this before drafting any Japanese male-audience isekai episode. It ports the generic story-writing skill's chapter engineering into the JP isekai workflow: emotion target, episode positioning, dense/sparse beat budgeting, payoff design, continuity, and end hook.
...
- Main line:
- Task/event line:
- Skill or system line:
- Relationship/social line:
- Logic chain: because X -> action Y -> result Z -> new problem
...
- final event
- unresolved hook
- new item, skill, familiar, monster part, debt, or document
- current location
- current social pressure
- promised next action
- running joke or emotional residue

The first scene must begin from one of these extracted items. Do not reopen the story as if the viewer forgot everything.
...
Do not expand by adding abstract reflection, generic destiny lines, decorative scenery, or repeated emotion words.
