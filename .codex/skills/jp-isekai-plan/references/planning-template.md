...
Use this structure for a full plan.

## Title Candidates

Provide 3-5 Japanese title candidates:

- Short title.
- Long なろう-style title.
- Comedic title if appropriate.
...
- Power/rank system:
- Economy:
- Why ordinary people struggle:
- Why the protagonist's cheat matters:
...
Make a two-column table: source concept -> Japanese isekai equivalent.
