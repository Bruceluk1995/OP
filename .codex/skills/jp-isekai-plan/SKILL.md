...
1. Resolve format/viewpoint only when missing:
   ...
   - For push mode, plan information/shot beats, causal gaps, oral transitions, and retention turns. First person plans narrator mouth and knowledge limits; third person plans narrator stance, stable labels, selective external reactions, and knowledge limits.
