...
- 角色先定义欲望、恐惧、误信、实用能力、羞耻点和“只有他/她会做的选择”，再写外貌与标签。
- 声线来自注意什么、忽略什么、怎样判断钱/危险/爱/地位、尴尬时如何自保，不靠统一口癖。
- 第一人称角色额外锁定知道/不知道、误解、隐瞒和不愿承认；第三人称也必须保持选择性镜头。
- 关系设计写清进入状态、会撕裂关系的选择、双方代价和退出状态；不把配角做成欢呼器、辱骂器或救援按钮。
- 交给写手的是紧凑角色卡与本场行为边界，不是整份人物传记。
