---
name: story-deslop
description: "小说与网文去 AI 味。先检测再做最小必要改写，清理模板句、解释腔、均匀节奏和模型退化，同时保护剧情事实、角色声线、题材惯例与字数目标。用于去AI味、文字太AI、润色网文、只检测AI痕迹；不是通用语法校对或剧情重写。"
...
修改前提取 3-5 个必须保留的声线指纹：叙事人称/距离、平均句长与停顿、情绪直白度、幽默/刻薄程度、角色口头习惯、题材允许的审判句或预告。修改后做回归检查；如果 AI 味下降但所有角色变成同一种“自然口语”、题材烈度被磨平或叙述距离改变，视为失败并恢复受影响段落。
