...
- 用户选择内容形态和日式男频／日本女频路线后，如果是没有具体 premise 的新作，必须依次完成 `六大故事类别 -> 该类别下的日本小说站子类目 -> 五项故事来源`。五项来源固定为：过去24小时实时热点／小说榜单、经典热门题材、冷门怪新方向、用户关键词、Codex 按口播传播性自动推荐。所有搜索和候选必须同时限制在已选类别和子类目内。表现形式、视角和长度放在具体故事方向之后确认。
- 选择实时热点／小说榜单后，Google Trends、新闻、YouTube、TikTok、日本小说站与中国小说站一律采用检索时刻向前滚动24小时的窗口；无法验证时间、周榜、月榜、旧调查或窗口外内容不得作为热点候选。
